...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno) {
        ...
        String valIncome[] = {"Null", "< 1.5 lac", "<2.5 lac", "<5 lac", "upto 10 lac"};
        ...
        String valEducation[] = {"Non-Graduate", "< Graduate", "Post Graduate", "PHD", "Others"};
    ...
    public void actionPerformed(ActionEvent ae){
      ...
      String saadhar =(String) aadhar.getText();
